...
fn main() {
    ...
    let queries = vec![
        ...
        "INSERT INTO users (user_id, first_name, last_name, email, age) VALUES (122, 'Michael', 'Brown', 'michael.brown@example.com', 40)",
        "INSERT INTO users (user_id, first_name, last_name, email, age) VALUES (543, 'Emily', 'Davis', 'emily.davis@example.com', 28)",
