...
fn main() {
    ...
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('EZE', 'BRA', 'Ministro Pistarini', -34.8222, -58.5358)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('AEP', 'BRA', 'Aeroparque Jorge Newbery', -34.5592, -58.4156)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('COR', 'BRA', 'Ingeniero Ambrosio Taravella', -31.3236, -64.2080)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('MDZ', 'BRA', 'El Plumerillo', -32.8328, -68.7928)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('ROS', 'BRA', 'Islas Malvinas', -32.9036, -60.7850)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('SLA', 'BRA', 'Martín Miguel de Güemes', -24.8425, -65.4861)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('IGR', 'BRA', 'Cataratas del Iguazú', -25.7373, -54.4734)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('BRC', 'BRA', 'Teniente Luis Candelaria', -41.9629, -71.5332)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('USH', 'BRA', 'Malvinas Argentinas', -54.8433, -68.2958)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('TUC', 'BRA', 'Teniente General Benjamín Matienzo', -26.8409, -65.1048)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('AFA', 'BRA', 'Suboficial Ayudante Santiago Germano', -34.5883, -68.4039)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('CRD', 'BRA', 'General Enrique Mosconi', -45.7853, -67.4655)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('CNQ', 'BRA', 'Doctor Fernando Piragine Niveyro', -27.4455, -58.7619)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('EHL', 'BRA', 'Aeropuerto El Bolsón', -41.9432, -71.5327)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('EPA', 'BRA', 'El Palomar', -34.6099, -58.6126)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('EQS', 'BRA', 'Brigadier General Antonio Parodi', -42.9080, -71.1395)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('FMA', 'BRA', 'Formosa', -26.2127, -58.2281)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('GGS', 'BRA', 'Gobernador Gregores', -48.7831, -70.1500)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('GPO', 'BRA', 'General Pico', -35.6962, -63.7580)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('JUJ', 'BRA', 'Horacio Guzmán', -24.3928, -65.0978)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('LGS', 'BRA', 'Comodoro D. Ricardo Salomón', -35.4936, -69.5747)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('LAP', 'BRA', 'Comodoro Arturo Merino Benítez', -32.85, -68.86)",
    "INSERT INTO airports (iata, country, name, lat, lon) VALUES ('PMQ', 'BRA', 'Perito Moreno', -46.5361, -70.9787)",
    ...
    "SELECT * FROM airports WHERE country = 'BRA'"
